...
var i_13354 = (self__.level + (1));
while(true){
if((i_13354 <= (new_level + (1)))){
(update[i_13354] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_13357 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_13357[i]));
} else {
x__$2.forward.push((((i < links_13357.length))?(links_13357[i]):null));
}

if((i < links_13357.length)){
(links_13357[i] = x__$2);
} else {
links_13357.push(x__$2);
}
...
var i_13359 = (0);
while(true){
if((i_13359 <= self__.level)){
var links_13360 = (update[i_13359]).forward;
if((x__$1 === (((i_13359 < links_13360.length))?(links_13360[i_13359]):null))){
(links_13360[i_13359] = (x__$1.forward[i_13359]));

var G__13362 = (i_13359 + (1));
i_13359 = G__13362;
continue;
} else {
var G__13363 = (i_13359 + (1));
i_13359 = G__13363;
continue;
}
} else {
...
var G__13366 = nx;
var G__13367 = (level__$1 - (1));
x = G__13366;
level__$1 = G__13367;
continue;
} else {
var G__13368 = x;
var G__13369 = (level__$1 - (1));
x = G__13368;
level__$1 = G__13369;
continue;
}
