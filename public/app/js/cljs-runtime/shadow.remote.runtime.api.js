...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_17528 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_17528(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_17529 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_17529(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_17530 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_17530(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_17534 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_17534(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_17540 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_17540(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_17541 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_17541(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__17524,callback){
var map__17525 = p__17524;
var map__17525__$1 = cljs.core.__destructure_map(map__17525);
var input = map__17525__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17525__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17525__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
